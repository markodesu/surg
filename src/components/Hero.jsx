    ...
    <section id="hero" className="relative overflow-hidden">
      ...
      <div className="mx-auto grid max-w-7xl gap-12 px-4 py-16 sm:px-6 lg:grid-cols-[1.08fr_0.92fr] lg:px-8 lg:py-24">
        <div className="flex flex-col justify-center">
          ...
          >
            Нейрохирург в Бишкеке — Доктор Нурлан Абдрахманов
          </motion.h1>
          ...
          >
            ...
            системы. Прием нейрохирурга в клинике Бишкека с вниманием к
            диагностике, маршрутизации и аккуратной тактике лечения.
          </motion.p>
                ...
                <div className="flex items-start justify-between gap-4">
                  <div>
                    ...
                    <p className="mt-2 max-w-xs text-sm leading-6 text-slate-600">
                      Здесь можно разместить качественное фото специалиста в
                      рабочем кабинете или во время консультации.
                    </p>
                  </div>
                ...
                <div className="grid gap-3 sm:grid-cols-2">
                  <div className="rounded-2xl border border-slate-200 bg-white/80 p-4">
                    ...
                    <p className="mt-2 text-sm font-medium text-slate-900">
                      Консультация, диагностика, сопровождение лечения
                    </p>
                  </div>
                  <div className="rounded-2xl border border-slate-200 bg-white/80 p-4">
                    <p className="text-xs font-semibold uppercase tracking-[0.2em] text-slate-500">
